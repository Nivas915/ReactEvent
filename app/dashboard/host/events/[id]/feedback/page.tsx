...
import { ThumbsUp, ThumbsDown, Heart, AlertCircle, Pin, Flag, MessageSquare, User } from "lucide-react"
...
const mockFeedback = [
  {
    id: "1",
    content: "Great presentation on the new features!",
  ...
  {
    id: "2",
    content: "Could you explain more about the pricing model?",
    timestamp: "2023-06-20T14:18:00",
    reaction: "🤔",
    user: "Sarah Miller",
    isPinned: true,
    isFlagged: false,
  ...
  {
    id: "3",
    content: "The demo was very helpful, thanks!",
  ...
  {
    id: "4",
    content: "I'm having trouble understanding the integration process.",
    timestamp: "2023-06-20T14:25:00",
    reaction: "👎",
    user: "Emily Wilson",
    isPinned: false,
    isFlagged: false,
...
export default function EventFeedbackPage() {
  ...
  const handlePinFeedback = (id: string) => {
  ...
  // Count reactions
  const reactionCounts = feedback.reduce(
    (acc, item) => {
